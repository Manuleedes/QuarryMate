...
import com.Lidigu.request.UpdateCartItemRequest;
import com.Lidigu.service.CartSerive;
...
public class CartController {
	...
	public ResponseEntity<CartItem> addItemToCart(@RequestBody AddCartItemRequest req,
			@RequestHeader("Authorization") String jwt) throws UserException, MaterialException, CartException, CartItemException {
